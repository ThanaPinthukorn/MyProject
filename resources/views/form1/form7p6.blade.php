                            ...
                            <div class="col-md-10">
                                ...
                                <table class="table table-bordered" >
                                    <tr>
                                        ...
                                        <th colspan="6">ระดับของความชอบผลิตภัณฑ์</th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6a" class="form-control nb" >
                                            @error('sample_6a')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6c" class="form-control nb" >
                                            @error('sample_6c')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6s" class="form-control nb" >
                                            @error('sample_6s')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6t" class="form-control nb" >
                                            @error('sample_6t')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6ta" class="form-control nb" >
                                            @error('sample_6ta')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sample_6o" class="form-control nb" >
                                            @error('sample_6o')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                        </td>
