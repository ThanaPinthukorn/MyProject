        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('form2.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <center class="mb-4"><h4>แบบทดสอบชิมแบบพรรณนาเชิงปริมาณ</h4></center>
                        ...
                        <div class="row mb-3">
                            <label for="detailed" class="col-md-2 col-form-label text-md-end">{{ __('คําชี้แจง') }}</label>

                            <div class="col-md-9">
                                <input id="detailed" type="text" class="form-control @error('detailed') is-invalid @enderror" name="detailed" value="{{ old('detailed') }}" required autocomplete="detailed" autofocus>
