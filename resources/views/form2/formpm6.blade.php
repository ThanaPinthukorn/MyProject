...
@section('style')
    <style>
        ...
        .three::-moz-range-thumb{
            background: #ff7708;
        }
        .four::-moz-range-thumb{
            background: #ff0000;
        }
        .five::-moz-range-thumb{
            background: #c300ff;
        }
                                ...
                                <table class="table table-borderless" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="csample_3">
                                            </div>
                                            @error('csample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="csample_4">
                                            </div>
                                            @error('csample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="csample_5">
                                            </div>
                                            @error('csample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="csample_6">
                                            </div>
                                            @error('csample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="smsample_3">
                                            </div>
                                            @error('smsample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="smsample_4">
                                            </div>
                                            @error('smsample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="smsample_5">
                                            </div>
                                            @error('smsample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="smsample_6">
                                            </div>
                                            @error('smsample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="ssample_3">
                                            </div>
                                            @error('ssample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="ssample_4">
                                            </div>
                                            @error('ssample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="ssample_5">
                                            </div>
                                            @error('ssample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="ssample_6">
                                            </div>
                                            @error('ssample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="swsample_3">
                                            </div>
                                            @error('swsample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="swsample_4">
                                            </div>
                                            @error('swsample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="swsample_5">
                                            </div>
                                            @error('swsample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="swsample_6">
                                            </div>
                                            @error('swsample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="spsample_3">
                                            </div>
                                            @error('spsample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="spsample_4">
                                            </div>
                                            @error('spsample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="spsample_5">
                                            </div>
                                            @error('spsample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="spsample_6">
                                            </div>
                                            @error('spsample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="msample_3">
                                            </div>
                                            @error('msample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="msample_4">
                                            </div>
                                            @error('msample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="msample_5">
                                            </div>
                                            @error('msample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="msample_6">
                                            </div>
                                            @error('msample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="rsample_3">
                                            </div>
                                            @error('rsample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="rsample_4">
                                            </div>
                                            @error('rsample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="rsample_5">
                                            </div>
                                            @error('rsample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="rsample_6">
                                            </div>
                                            @error('rsample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="vsample_3">
                                            </div>
                                            @error('vsample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="vsample_4">
                                            </div>
                                            @error('vsample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="vsample_5">
                                            </div>
                                            @error('vsample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="vsample_6">
                                            </div>
                                            @error('vsample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider two" name="osample_3">
                                            </div>
                                            @error('osample_3')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider three" name="osample_4">
                                            </div>
                                            @error('osample_4')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider four" name="osample_5">
                                            </div>
                                            @error('osample_5')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
                                            <div class="slidecontainer">
                                                <input type="range" min="0" max="20" value="10" class="slider five" name="osample_6">
                                            </div>
                                            @error('osample_6')
                                                <div class="alert alert-danger">{{ @message }}</div>
                                            @enderror
